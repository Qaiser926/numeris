...
class Q43 extends StatefulWidget {
  ...
  @override
  Q43State createState() => Q43State();
}

class Q43State extends State<Q43> {
  ...
  void buttonTapped() {
    ...
    setState(()   async {
      ...
      success==true? await userCollection.doc(widget.childName).update({"Q43": "1"}):
      await userCollection.doc(widget.childName).update({"Q43": "0"});
  ...
  void goToNextQuestion() {
    ...
    Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) =>  Q44(childName: widget.childName)));
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.start,
                        children: [
                          CountdownPage(path: Q44(childName: widget.childName),),
