...
class Q18 extends StatefulWidget {
  ...
  const Q18({super.key,required this.childName});

  @override
  Q18State createState() => Q18State();
}

class Q18State extends State<Q18> {
...
initTts();
  ...
  void buttonTapped() {
    ...
    setState(()   async {
      ...
      success==true? await userCollection.doc(widget.childName).update({"Q18": "1"}):
      await userCollection.doc(widget.childName).update({"Q18": "0"});
  ...
  void goToNextQuestion() {
    ...
    Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) =>  Q19(childName: widget.childName,)));
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          CountdownPage(path: Q19(childName: widget.childName),),
