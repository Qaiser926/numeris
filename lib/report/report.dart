...
class Report extends StatefulWidget {
  ...
  const Report({super.key, required this.childName});
                                      ...
                                      Padding(
                                        ...
                                        child: SizedBox(
                                          ...
                                          child: ElevatedButton(
                                            ...
                                            child: Center(child: Text('Share'.tr,textAlign: TextAlign.center,style: TextStyle(
...
// get Q1 to Q92 values
    ...
    if (qValues.contains('Q67') || qValues.contains('Q68') ||
      ...
      List<String> newItems = ["-Halving up to 20","-Halving on the arithmetic line","-Even and odd numbers"];
      for (String item in newItems) {
        if (!itemsAdded.contains(item)) {
          itemsAdded.add(item);
          newText += "\n$item";
