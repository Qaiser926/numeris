...
class Q44 extends StatefulWidget {
  ...
  @override
  Q44State createState() => Q44State();
}

class Q44State extends State<Q44> {
  ...
  Future<void> buttonTapped() async {
    ...
    setState(()    {
      ...
      success==true? await userCollection.doc(widget.childName).update({"Q44": "1"}):
      await userCollection.doc(widget.childName).update({"Q44": "0"});
  ...
  void goToNextQuestion() {
    ...
    Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) =>  Q45(childName: widget.childName,)));
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          CountdownPage(path: Q45(childName: widget.childName),),
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      "Count_forward_in_steps_of_10".tr,
