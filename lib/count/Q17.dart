...
class Q17State extends State<Q17> {
  ...
  void buttonTapped() {
    ...
    setState(() async {
      ...
      success == true
          ? await userCollection.doc(widget.childName).update({"Q17": "1"})
  ...
  void goToNextQuestion() {
    ...
    Navigator.pushReplacement(
        context,
        MaterialPageRoute(
            builder: (context) => Q18(childName: widget.childName)));
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          CountdownPage(
                            path: Q18(childName: widget.childName),
                          ),
                          SizedBox(
                                      ...
                                      onTap: () async {
                                        ...
                                        if (isSave) {
                                          await flutterTts.speak(
                                              "Count_forward_in_steps_of_two_from_36"
                                                  .tr);
                                        } else {
                                          await flutterTts.setSilence(1);
                                        }
