...
class Q6 extends StatefulWidget {
  ...
  const Q6({super.key,required this.childName});

  @override
  Q6State createState() => Q6State();
}
...
initTts();
  ...
  Future<void> buttonTapped() async {
    ...
    final FirebaseAuth auth = FirebaseAuth.instance;
      ...
      success==true? await userCollection.doc(widget.childName).update({"Q6": "1"}):
      await userCollection.doc(widget.childName).update({"Q6": "0"});
  ...
  void goToNextQuestion() {
    ...
    Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => BeforeAfter(childName: widget.childName)
        ));
        ...
        return SafeArea(
          child: Stack(
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          CountdownPage(path: BeforeAfter(childName: widget.childName),),
            ...
            onTap:  () async {
                final isSave = box.read("isCheck");
                if (isSave) {
                  await flutterTts.speak("Count_backward_from_the_number_100".tr);
                } else {
                  await flutterTts.setSilence(1);
                }
              },
                                      child: Text(
                                        "Count_backward_from_the_number_100".tr,
                                ...
                                Row(
                                  ...
                                  children: [
                                    KeypadButton('1', () {
                                      setState(() {
                                        answer += '1';
                                        if(i<=4){ controllerList[i].text =','+answer;} else if(i>=5){controllerList1[i-5].text =','+answer;}
                                      });
                                    }),
                                    KeypadButton('2', () {
                                      setState(() {
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    KeypadButton('8', () {
                                      setState(() {
                                        answer += '8';
                                        if(i<=4){ controllerList[i].text =','+answer;}
                                        else if(i>=5){controllerList1[i-5].text =','+answer;}
                                      });
                                    }),
                                  ],
                                ),
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    ActionButton(Icons.check, ColorManager.lightGreen,onPressed: (){
                                      ...
                                      i<=4? order.add(int.parse(controllerList[i].text.replaceAll(',',''))): i>=5&& i<=9? order.add(int.parse(controllerList1[i-5].text.replaceAll(',',''))): null;
                                      setState(() {
              ...
              child: TextField(
                style:   GoogleFonts.montserrat(
                  textStyle: TextStyle(fontSize: MediaQuery
                      .of(context)
                      .size
                      .width * 0.022, color: colorlist[index], fontWeight: FontWeight.bold),),
