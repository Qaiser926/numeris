...
void goToNextQuestion() {
  ...
  Navigator.push(
    context,
    MaterialPageRoute(builder: (context) =>   Q20(childName: widget.childName,)),
  );
...
Future<void> checkResult() async {
  ...
  success==true? await userCollection.doc(widget.childName).update({"Q19": "1"}):
                                ...
                                child: Row(
                                  ...
                                  children:  [
                                    SizedBox(width:MediaQuery
                                     ...
                                     CountdownPage(path: Q20(childName: widget.childName),),
                                    // SizedBox(width:MediaQuery
                                    //     .of(context)
                                    //     .size
                                    //     .width * 0.028 ,),
