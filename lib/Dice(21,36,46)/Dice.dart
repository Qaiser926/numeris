...
class DiceState extends State<Dice> {
  ...
  String userAnswer5 = '?';
  String userAnswer6 = '?';
  String together_dice = "Together_the_two_dice_show";
  String number_on_dice = "what_could_the_number_on_the_dice_be";
        ...
        : widget.number == 10
            ...
            : widget.number == 18
                ? Navigator.pushReplacement(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            PlusMinus(childName: widget.childName)))
                : null;
  }
  ...
  Future<void> buttonTapped() async {
    ...
    if (widget.number == 7) {
      int.parse(userAnswer) + int.parse(userAnswer1) == widget.number &&
              int.parse(userAnswer2) + int.parse(userAnswer3) ==
                  widget.number &&
              int.parse(userAnswer4) + int.parse(userAnswer5) == widget.number
    ...
    return Row(
      ...
      children: [
        ...
        Icon(
          ...
          size: MediaQuery.of(context).size.width * 0.09 / 1.5625,
      ...
      children: <Widget>[
        ...
        Positioned(
          bottom: MediaQuery.of(context).size.width *
              0.087 /
              1.875, // adjust this value to position the text as desired
          left: MediaQuery.of(context).size.width *
              0.088 /
              2.272, // adjust this value to position the text as desired
          child: Text(
            m,
            style: TextStyle(
              color: Colors.white,
              fontSize: MediaQuery.of(context).size.width * 0.087 / 4.1667,
              fontWeight: FontWeight.bold,
            ),
          ),
        ),
