...
class Q17 extends StatefulWidget {
  ...
  const Q17({super.key,required this.childName});

  @override
  Q17State createState() => Q17State();
}

class Q17State extends State<Q17> {
  ...
  void buttonTapped() {
    ...
    setState(()   async {
      ...
      success==true? await userCollection.doc(widget.childName).update({"Q17": "1"}):
      await userCollection.doc(widget.childName).update({"Q17": "0"});
  ...
  void goToNextQuestion() {
    ...
    Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) =>   Q18(childName: widget.childName
        )));
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          CountdownPage(path: Q18(childName: widget.childName),),
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      "Count_forward_in_steps_of_two_from_36".tr,
