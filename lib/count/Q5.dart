...
class Q5State extends State<Q5> {
  ...
  void buttonTapped() {
    ...
    setState(() async {
      ...
      success == true
          ? await userCollection.doc(widget.childName).update({"Q5": "1"})
  ...
  void goToNextQuestion() {
    ...
    Navigator.pushReplacement(
        context,
        MaterialPageRoute(
            builder: (context) => Q6(childName: widget.childName)));
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          CountdownPage(
                            path: Q6(childName: widget.childName),
                          ),
                          SizedBox(
                                      ...
                                      onTap: () async {
                                        ...
                                        if (isSave) {
                                          await flutterTts.speak(
                                              "Count_forward_from_the_number_66"
                                                  .tr);
                                        } else {
                                          await flutterTts.setSilence(1);
                                        }
